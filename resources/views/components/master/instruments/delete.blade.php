<x-button.delete :action="route('dashboard.master.instruments.destroy', $instrument->uuid)" color="danger" size="{{ $size ?? 'md' }}">
  ...
  <dl class="max-w-md divide-y divide-gray-200 text-gray-900">
    ...
    <div class="flex flex-col pt-3">
      ...
      <dd class="font-semibold">{{ $instrument->instrument }}</dd>
    </div>
  </dl>
</x-button.delete>