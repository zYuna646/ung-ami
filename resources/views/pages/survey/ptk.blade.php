@extends('layouts.app', [
    'title' => 'Permintaan Tindakan Koreksi Kategori KTS',
    'showAlert' => false,
])
@section('content')
	@if (session('success'))
	...
	<section class="mx-auto grid w-full max-w-screen-xl gap-5 p-5 pt-7">
		...
		<x-main.card>
			<div class="flex flex-col items-start justify-between gap-y-2 sm:flex-row sm:items-center">
				<div>
					...
					<p class="text-xl uppercase text-slate-500">Permintaan Tindakan Koreksi Kategori KTS</p>
				</div>
			</div>
		</x-main.card>
		<div class="grid grid-cols-1 items-start gap-6 sm:grid-cols-3">
			...
			<div class="col-span-2">
				<x-survey.form5 :$instrument :$showInstrument :$questions />
			</div>
		</div>
	</section>
@endsection
