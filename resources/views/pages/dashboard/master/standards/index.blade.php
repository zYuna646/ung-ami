...
@section('content')
	<x-main.section>
		<div class="flex flex-col justify-between gap-5 rounded-lg border border-slate-100 bg-white p-6 shadow-sm sm:flex-row sm:items-center">
			...
			<div>
				<x-button :href="route('dashboard.master.standards.create')" color="info">
					Tambah Data
				</x-button>
			</div>
		</div>
							...
							<tr>
								...
								<td>
									<div class="inline-flex gap-x-2">
										<x-button :href="route('dashboard.master.standards.edit', $standard->uuid)" color="success" size="sm">
											Edit
										</x-button>
										@can('delete', $standard)
											<x-button.delete :action="route('dashboard.master.standards.destroy', $standard->uuid)" size="sm">
												...
												<dl class="max-w-md divide-y divide-gray-200 text-gray-900">
													<div class="flex flex-col pb-3">
														...
														<dd class="font-semibold">{{ $standard->uuid }}</dd>
													</div>
													<div class="flex flex-col pt-3">
														<dt class="mb-1 text-gray-500">Standar</dt>
														<dd class="font-semibold">{{ $standard->name }}</dd>
													</div>
												</dl>
											</x-button.delete>
										@endcan
